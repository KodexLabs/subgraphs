...
test('NewOrder contains all data from a OrderValidated event', () => {
	...
	const seaportPausableZone = Address.fromString('0x004C00500000aD104D7DBd00e3ae0A5C00560C00');

	const orderHash = Bytes.fromHexString('0x000ee3e4ef4086422253e8f605896fad9057172bf0f0a982ce053c0c8fdef590');

	const orderValidatedEvent = createOrderValidatedEvent(alice, orderHash, bob, seaportPausableZone);
